Prerequisites:
 - create-react-native-app installed. [Installation instructions can be found here](https://github.com/react-community/create-react-native-app).
 - watchman. I built from source, because I'm on fedora. There are binaries available for Windows (Beta) and for Mac via Homebrew. [More info available here](https://facebook.github.io/watchman/docs/install.html).

Below you will find the README generated by create-react-native-app.
